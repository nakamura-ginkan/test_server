...
app.modal = function () {
  ...
  $(window).on('click', function (e) {
    var target = $(e.target);
    if (
      !target.hasClass('js-open-modal') &&
      !target.parents('.js-modal-popup').length
    ) {
  ...
  var init = function () {
    button.on('click', function (e) {
      ...
      if (
        currentButton.hasClass('is-toggle') &&
        currentButton.hasClass('is-active')
      ) {
        modal.removeClass('is-show');
        button.removeClass('is-active');
        return;
...
app.tooltip = function () {
  ...
  buttonTooltip.each(function (index, item) {
    ...
    currentButton.on('click', function () {
      ...
      var xValue =
        currentButton.offset().left +
        currentButton.width() / 2 -
        currentTooltip.width() / 2;
      var x = xValue + 'px';
      ...
      if (
        app.isDesktop() &&
        xValue + currentTooltip.width() > $(window).width()
      ) {
  ...
  $(window).on('click', function (e) {
    var target = $(e.target);
    if (
      !target.hasClass('js-button-tooltip') &&
      !target.parents('.tooltip-wrapper').length
    ) {
      $('.tooltip-wrapper').removeClass('is-active');
      buttonTooltip.removeClass('is-active');
    }
...
app.toggleActive = function () {
  ...
  $(document).on('click', function (e) {
    var target = $(e.target);
    if (
      !target.hasClass('js-toggle-active') &&
      !target.parents('.js-toggle-active').length
    ) {
